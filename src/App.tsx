...
const pages:{id:Page;label:string;description:string;icon:IconName}[]=[
  {id:'devices',label:'设备',description:'自动读取 Tailscale 设备，一键打开 Windows 远程桌面',icon:'devices'},
...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {page==='remote'&&<RemoteWorkspace state={state} onDevices={()=>navigate('devices')}/>}
