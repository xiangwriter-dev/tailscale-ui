...
export function DeviceDetail({state}:{state:TailTaskState}) {
  ...
  return <aside className="panel device-detail" aria-label="所选设备详情">
    ...
    <div className="permission-note"><Icon name="shield"/><div><strong>远程修复未开放</strong><p>网络在线与修复授权分别管理。本机修复始终只作用于这台电脑上的应用数据。</p></div></div>
  </aside>;
}
export function Devices({state,onAdd}:{state:TailTaskState;onAdd:()=>void}) {
