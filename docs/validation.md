...
| Rust | 工作区 check / fmt 通过；38 个工作区测试通过（含 2 个辅助入口），追加文件限制测试后 remote 包 11 项回归通过，Windows 测试总数 39 |
...
最终本地安装包 `xiangwriter远程器_0.2.0_x64-setup.exe`，5,357,049 字节，SHA-256：`79ebeca2f28a4d9ad5430ec07e90e49f68e2fb0a234989532ebad1041b5fc96f`。包含 Darwin 修复与设置页权限说明更新，实际安装后的程序再次完成配对、exec/script、幂等、取消、重启与撤销验证；安装与卸载退出码均为 0。
